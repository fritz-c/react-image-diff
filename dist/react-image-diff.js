	  ...
	  _createClass(ImageDiff, [{
	    ...
	    value: function getScaledDimensions() {
	      ...
	      var _props = this.props,
	          maxWidth = _props.width,
	          maxHeight = _props.height;
	      ...
	      if (naturalHeightBefore && naturalHeightAfter) {
	        ...
	        var _getDimensions3 = getDimensions(maxHeight, maxWidth, naturalHeightBefore, naturalWidthBefore);

	        height = _getDimensions3.height;
	        width = _getDimensions3.width;
	      } else if (naturalHeightAfter) {
	        var _getDimensions4 = getDimensions(maxHeight, maxWidth, naturalHeightAfter, naturalWidthAfter);

	        height = _getDimensions4.height;
	        width = _getDimensions4.width;
	      }
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement('img', {
	            ...
	            onLoad: function onLoad(e) {
	              return _this4.handleImgLoad(e, 'Before');
	            }
	          })
	        ),
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement('img', {
	              ...
	              onLoad: function onLoad(e) {
	                return _this4.handleImgLoad(e, 'After');
	              }
	            })
	          )
	        )
	    ...
	    value: function render() {
	      ...
	      var _props2 = this.props,
	          ...
	          _afterAlt = _props2.afterAlt,
	          _beforeAlt = _props2.beforeAlt,
	          _type = _props2.type,
	          _value = _props2.value,
	          _imageStyle = _props2.imageStyle,
	          _onImageLoad = _props2.onImageLoad,
	          style = _props2.style,
	          otherProps = _objectWithoutProperties(_props2, ['width', 'height', 'after', 'before', 'afterAlt', 'beforeAlt', 'type', 'value', 'imageStyle', 'onImageLoad', 'style']);
